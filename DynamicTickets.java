...
public class DynamicTickets {
    ...
    public static void main(String[] args) {
     ...
     // Label in the first panel
        ...
        chooseTicketPanel.add(Box.createVerticalStrut(210));
        ...
        dynamicPanel.setBackground(Color.GREEN);
        dynamicPanel.setBounds(200, 0, 600, 700);
        dynamicPanel.setLayout(new BoxLayout(dynamicPanel, BoxLayout.Y_AXIS));

        JLabel dynamicLabel = new JLabel("Welcome User!");
        dynamicLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        dynamicLabel.setFont(new Font("Arial", Font.BOLD, 20));
        dynamicLabel.setForeground(Color.BLACK);

        dynamicPanel.add(Box.createVerticalStrut(52));
